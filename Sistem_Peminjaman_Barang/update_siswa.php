	...
	<div class="row">
		<div class="col-md-6 offset-md-3">
			...
			<?php
				...
				$data = mysqli_query($conn, "SELECT nama, kelas from siswa where nama='$no'");
				while($d = mysqli_fetch_array($data)) { 
			?>
				<table width="419" border="0" class="table table-dark">
					<tr>
						<td width="152">Username</td>
						<td width="138"><input name="nama" type="text" id="nama" value="<?php echo $d['nama']; ?>"size="20" /></td>
						<td width="138"><input name="nama2" type="hidden" id="nama" value="<?php echo $d['nama']; ?>" size="20" /></td>
					</tr>

					<tr>
						<td>Kelas</td>
						<td><select name='kelas' value="<?php echo $d['kelas']; ?>"><?php echo $d['kelas']; ?>
					...
					<tr>
						...
						<td width="92"><a href="data_siswa.php" button class="btn btn-warning" type="button">Batal</a></button></td>
					</tr>
				</table>
