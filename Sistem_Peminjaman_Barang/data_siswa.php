...
<?php
	...
	$sql_limit = "select * from siswa order by nama limit $mulai_dari, $limit";
...
?>
	<tr class="success">
		...
		<td>
		<a href= "update_siswa.php?id=<?php echo $data[1];?>" class="update">Update</a>
		<a href= "hapus_siswa.php?id=<?php echo $data[1];?>" class="delete" onclick= "javascript: return confirm('Anda yakin menghapus data Siswa <?php echo $data[1];?>?')">Hapus</a>
		</td>
	</tr>
